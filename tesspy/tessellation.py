...
class Tessellation:
    ...
    def adaptive_quadkey(self,
        ...
        start_resolution : int
            ...
            A positive number between todo: complete
        poi_categories : A list of OSM primary map features, default=["amenity", 'building']
            Possible values in the list: ['aerialway', 'aeroway', 'amenity', 'barrier',
            'boundary', 'building', 'craft', 'emergency', 'geological', 'healthcare',
            'highway', 'historic', 'landuse', 'leisure', 'man_made', 'military', 'natural',
            'office', 'place', 'power', 'public_transport', 'railway', 'route', 'shop',
            'sport', 'telecom', 'tourism', 'water', 'waterway']
        threshold : int, default=None
            Threshold for the number of POI in a single square. If square
            has more, it is divided into four squares. If None passed, the median
            number of POI per square in the initial level is used as threshold.
    ...
    def voronoi(self,
        ...
        cluster_algo : {'k-means', 'hdbscan', None}, default='k-means'
            Algorithm for clustering the POI data before creating Voronoi generators
            If None passed, POI data are directly used as generators.
        poi_categories : A list of OSM primary map features, default=["amenity", 'building']
            Possible values in the list: ['aerialway', 'aeroway', 'amenity', 'barrier',
            'boundary', 'building', 'craft', 'emergency', 'geological', 'healthcare',
            'highway', 'historic', 'landuse', 'leisure', 'man_made', 'military', 'natural',
        ...
        n_polygons : int, default=100
            Only when cluster_algo="k-means", number of polygons to be created
            Positive number and less than the initial POI numbers
        ...
        if cluster_algo == "k-means":
            ...
            generators = [np.mean(data_locs[cluster_labels == label], axis=0) for label in range(n_polygons)]
